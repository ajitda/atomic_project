...
<div  class="container">
    ...
    <form id="multiple"  method="post">
        <div class="nav navbar-default">
            ...
            <a href='sort.php' class='btn btn-lg bg-success'>Sort</a>

        </div>
        <div class="bg-info text-center"><h1>Birthday Sorted List</h1></div>
        ...
        <table border="1px" class="table table-bordered table-striped">
            ...
            <?php
           // echo "<pre>".Utility::vd_die($allData)."</pre>>";
            foreach ($akib as $oneData){
