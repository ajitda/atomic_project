...
if($list){
    ...
    foreach($allData as $row) {
        ...
        $id = $row->id;
        $name = $row->name;
        $profilePictureUrl = "Uploads/".$row->profile_picture;
        $profilePicture = $row->profile_picture;

        $sl++;
       // printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'>%s</td></tr>",$sl,$id,$name,$profilePicture);
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'><img src=".$profilePictureUrl." height='100px' width='100px' ></td></tr>",$sl,$id,$name);
