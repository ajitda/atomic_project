...
<head>
    ...
    <div class="container bg-success" style="margin-top: 100px">
        <h1 style="text-align: center"> Email - Add Form </h1>
        <div class="col-md-4">
            <h2> Left block</h2>
        </div>
        <div class="col-md-7" style="margin-top: 50px; margin-bottom: 50px">
            <form action="store.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Name" placeholder="Please Enter Book Title Here....">
                </div>
                <div class="form-group">
                    <label for="AuthorName">Email ID</label>
                    <input type="email" class="form-control" name="Email" placeholder="Please Enter Author Name Here....">
                </div>
