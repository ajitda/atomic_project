...
<div class="container">
    ...
    <form  role="form" method="post" action="email.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
        <div class="form-group">
            ...
            <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of Gender_info recommendation";} else {echo "A single Hobby recommendation";} ?>">
...
if($list){
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'>%s</td></tr>",$sl,$id,$name,$gender);
...
{
    printf("I'm recommending You: [<strong>Gender Info ID: </strong>%d, <strong>Name: </strong>%s, <strong>Gender: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->gender);
