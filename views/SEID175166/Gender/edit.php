    ...
    <div class="col-md-7" style="margin-top: 50px; margin-bottom: 50px">
        <form action="update.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="BookTitle" value="<?php echo $oneData->name ?>">
            </div>

            <div class="form-group">
                <label for="Gender">Gender</label>
                <input class="radio-inline" type="radio" name="Gender" value="male"  <?php echo ($oneData->gender=='Male')?'checked':'' ?> >Male
                <input class="radio-inline" type="radio" name="Gender" value="Female"  <?php echo ($oneData->gender=='Female')?'checked':'' ?> >Female
            </div>
