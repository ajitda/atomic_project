...
<div  class="container">
    ...
    <div style="margin-left: 70%">
        <form id="searchForm" action="index.php"  method="get" style="margin-top: 5px; margin-bottom: 10px ">
            ...
            <input type="checkbox"  name="byCompany"   checked  >By Company
            <input type="checkbox"  name="bySummary"  checked >By Summary
    ...
    <form id="multiple"  method="post">
        ...
        <div class="bg-info text-center"><h1>Summary of Organization - Active List</h1></div>
              ...
              foreach ($allData as $oneData){
                ...
                echo "
                      <tr  style='background-color: $bgColor'>
                         ...
                         <td style='width: 20%;'><b>$oneData->company_name</b></td>
